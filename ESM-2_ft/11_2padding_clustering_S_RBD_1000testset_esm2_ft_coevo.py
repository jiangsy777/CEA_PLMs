...
input_array0 = pickle.load(open('Spike_sampled_variant_not_in_training_set_ems2_ft_embedding.pkl','rb'))
method_name = 'Spike_seg_RBD_esm2_ft_coevo'
...
df_all_information = pd.read_csv('./Spike_sampled_variant_not_in_training_set.csv')
label_1 = list(df_all_information['variant'])
