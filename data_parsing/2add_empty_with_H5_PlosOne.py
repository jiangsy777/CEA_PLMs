...
if __name__ == "__main__":
    ...
    INPUT = "../data/generate/HA_with_aa_seq_without_wrong_seq_H5_mafft_del_empty_with_plosone.fasta"
    OUTPUT = "../data/generate/HA_with_aa_seq_without_wrong_seq_H5_mafft_del_empty_with_plosone_final.fasta"
    start_loc1 = 17
    end_loc1 = 359
