...
2. Coupled epistatic site calcuation with RBD sites based on CEA
    ```bash
...
7. Prediction and visualization of high-mutation-effect coupled epistatic mutations based on fine-tuned ESM-2
    ```bash
