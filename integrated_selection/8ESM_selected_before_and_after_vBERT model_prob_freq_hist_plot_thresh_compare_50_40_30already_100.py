...
for row_idx, sero in enumerate(serotype_lst):
    ...
    thresh = np.quantile(scores, 0.6, method='linear')
    # thresh = np.quantile(scores, 0.5, method='linear')
    print(thresh)
    # 数据清洗
...
# -------------------------- 6. 保存 --------------------------
# plt.savefig("vBERT_prob_hist_freq_before_after_ESM2_ft_score_H135_compare_40.png", dpi=600, bbox_inches="tight", facecolor="white")
plt.savefig("./generate/vBERT_prob_hist_freq_before_after_ESM2_ft_score_H135_compare_40.svg", dpi=600, bbox_inches="tight", facecolor="white")
# plt.show()

# plt.savefig("vBERT_prob_hist_freq_before_after_ESM2_ft_score_H135_compare_50.png", dpi=600, bbox_inches="tight", facecolor="white")
# plt.savefig("./generate/vBERT_prob_hist_freq_before_after_ESM2_ft_score_H135_compare_50.svg", dpi=600, bbox_inches="tight", facecolor="white")
plt.show()