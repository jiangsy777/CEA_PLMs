...
def process_subtype_heatmap(subtype_config, csv_path):
    ...
    thresh = np.quantile(df['site12_mutant_score'].values, 0.7, method='linear')
...
if __name__ == "__main__":
    INPUT_CSV = "./generate/HA_H1_human_CA07_ref_site12_AA_pair_top3_site2_for_each_selected_site1_with_esm2_logist_score_with_vBERT_predicted_prob_mean.csv"
    datasets = [
        {
            "title": "H1 Coevolution Score",
