...
if __name__ == "__main__":
    INPUT_CSV = "./generate/HA_H5_avian_Texas_ref_site12_AA_pair_top3_site2_for_each_selected_site1_with_esm2_logist_score_with_vBERT_predicted_prob_mean.csv"
    datasets = [
        {
            "title": "H5 Coevolution Score",
